...
export default function OrderDetails() {
  return (
    <DialogContent>
      <DialogHeader>
        <DialogTitle>Pedido: 5d41sd56ad1a5s1da45as</DialogTitle>
        <DialogDescription> Detalehs do pedido</DialogDescription>
      </DialogHeader>
        ...
        <Table>
          <TableBody>
            ...
            <TableRow>
              ...
              <TableCell className="flex justify-end">(16)996547857</TableCell>
            </TableRow>
            <TableRow>
